...
class Head(nn.Module):
    ...
    def forward(self, x):
        ...
        # TODO two n_embd, head_size, which one is used to normalize
...
# sentence -> tokenizer.encode -> set of numbers(vector of tokens) -> embedding(65, 128) -> a,e doesn't exist -> 
...
class BigramLanguageModel(nn.Module):
    def __init__(self):
        ...
        self.sa_head = Head(n_embd)   # keeping n_embd==head_size
...
# step 0: train_loss 4.1929, val_loss 4.1906
# step 500: train_loss 2.7089, val_loss 2.7284
# step 1000: train_loss 2.5222, val_loss 2.5335
# step 1500: train_loss 2.4673, val_loss 2.4793
# step 2000: train_loss 2.4355, val_loss 2.4678
# step 2500: train_loss 2.4347, val_loss 2.4463
# step 3000: train_loss 2.4165, val_loss 2.4403
# step 3500: train_loss 2.4104, val_loss 2.4305
# step 4000: train_loss 2.3932, val_loss 2.4227
# step 4500: train_loss 2.3904, val_loss 2.4094
# step 5000: train_loss 2.3882, val_loss 2.4091
# step 5500: train_loss 2.3719, val_loss 2.4053
# step 6000: train_loss 2.3674, val_loss 2.3996
# step 6500: train_loss 2.3714, val_loss 2.3962
# step 7000: train_loss 2.3608, val_loss 2.3971
# step 7500: train_loss 2.3610, val_loss 2.3967
# final loss: 2.3361990451812744 after 8000 steps.
